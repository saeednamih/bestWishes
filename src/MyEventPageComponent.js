...
import './MyEventPageComponent.css';
import addWish from '../assets/images/addWish.jpg';
export default class MyEventPageComponent extends React.Component {
    render() {
        return (
            <>
                ...
                <main role="main">
                    ...
                    <section className="jumbotron text-center">
                        <div className="container">
                            <h1 className="jumbotron-heading">My Events</h1>
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="card mb-4 shadow-sm">
                                        <img className="img img-responsive full-width" src={addWish}/>
